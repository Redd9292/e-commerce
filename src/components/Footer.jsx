    ...
    <footer className="bg-white dark:bg-gray-900">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            ...
            <a href="#" className="flex items-center">
              <img src={logo} alt="OmniMart Logo" className="h-32 w-auto" /> {/* Adjust the size as needed */}
            </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4">
            ...
            <div>
              <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Tech Resources</h2>
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                  <a href="#" className="hover:underline">Tech Blogs</a>
                </li>
                <li className="mb-4">
                  <a href="#" className="hover:underline">Gadget Reviews</a>
                </li>
                <li className="mb-4">
                  <a href="#" className="hover:underline">Developer Tools</a>
                </li>
                <li>
                  <a href="#" className="hover:underline">Tech News</a>
                </li>
              </ul>
            </div>
            <div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#" className="hover:underline">OmniMart™</a>. All Rights Reserved.
          </span>
